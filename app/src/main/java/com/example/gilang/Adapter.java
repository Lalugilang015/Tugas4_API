...
public class Adapter extends ArrayAdapter {
    ...
    Context context;
    ArrayList<com.example.gilang.DataOperasi> datas = new ArrayList();
    LayoutInflater layoutInflater;

    ImageView img;
    TextView title, lateVersi, dev, website, description;

    public Adapter(Context context, ArrayList<com.example.gilang.DataOperasi> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.example.gilang.DataOperasi data = datas.get(position);
